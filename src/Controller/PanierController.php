...
public function modifierEtatCommande(EntityManagerInterface $entityManager, Request $request, $id, MailerInterface $mailer, TwigEnvironment $twig)
{
    ...
    if ($request->isMethod('POST')) {
        ...
        $commande->setEtat($etatCommande === 'nonLivree' ? 'non livrée' : 'en attente de paiement');
        ...
        return $etatCommande === 'nonLivree' ? $this->redirectToRoute('app_test') : $this->redirectToRoute('stripe');
    }
